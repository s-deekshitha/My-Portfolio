export default function ContactMe() {
    return (
      <section id="Contact" className="contact--section">
        <div>
          <p className="sub--title">Let's Get in Touch: Ways to Connect with Me</p><div className="subtitle contact-subtitle">
          "Thank you for taking your prcecious time and look up to this!!For professional inquiries or collaborations, connect with me on <br /> <b>LinkedIn: [https://www.linkedin.com/in/snvsdeekshitha/]</b>. <br /> You can explore my coding projects<br /> <b>GitHub: [https://github.com/s-deekshitha].</b>  <br />For direct communication, drop me an email at <b>[deethusandaka@gmail.com].</b> Let's connect and explore exciting opportunities together!"
						</div>
